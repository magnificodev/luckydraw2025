-- =====================================================
-- VPBank Lucky Draw - Fixed Database Schema
-- =====================================================
-- Fixed version without duplicate wheel segments
-- Use this instead of database_no_drop.sql
...
-- FIXED: No duplicate wheel segments!
